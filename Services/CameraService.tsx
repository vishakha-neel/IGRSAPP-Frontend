...
export async function addImage(fileID: string , district: string, subDistrict: string, pageNumber: string , uri :string) {

const BASE_URL = Constants.expoConfig?.extra?.BASE_URL; // Replace with correct ngrok or prod URL
const url = `${BASE_URL}/api/pdf/add/${fileID}/${district}/${subDistrict}/${pageNumber}`;
...
export async function deletePage(fileID: string , district: string, subDistrict: string, pageNumber: string) {

  const BASE_URL = Constants.expoConfig?.extra?.BASE_URL; // Replace with correct ngrok or prod URL
  const url = `${BASE_URL}/api/pdf/delete/${fileID}/${district}/${subDistrict}/${pageNumber}`;
